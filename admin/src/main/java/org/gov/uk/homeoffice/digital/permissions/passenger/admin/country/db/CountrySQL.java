...
final class CountrySQL {
    ...
    static final String INSERT = "INSERT INTO countries (iso_country_code, enabled) VALUES (:country, :enabled)";
    static final String UPDATE = "UPDATE countries SET enabled = :enabled WHERE iso_country_code = :id";
